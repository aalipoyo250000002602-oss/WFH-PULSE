...
export function MiniCalendar({
    ...
    const getStatusColor = (
        ...
        switch (status) {
            case 'present':
                return isFuture
                    ? 'bg-vibrant-green/15 text-vibrant-green border-vibrant-green/25 cursor-pointer'
                    : 'bg-vibrant-green/20 text-vibrant-green border-vibrant-green/30 cursor-pointer hover:bg-vibrant-green/30'
            case 'late':
                return isFuture
                    ? 'bg-vibrant-orange/15 text-vibrant-orange border-vibrant-orange/25 cursor-pointer'
                    : 'bg-vibrant-orange/20 text-vibrant-orange border-vibrant-orange/30 cursor-pointer hover:bg-vibrant-orange/30'
            case 'absent':
                return isFuture
                    ? 'bg-destructive/15 text-destructive border-destructive/25 cursor-pointer'
                    : 'bg-destructive/20 text-destructive border-destructive/30 cursor-pointer hover:bg-destructive/30'
            case 'on-leave':
                return isFuture
                    ? 'bg-vibrant-purple/15 text-vibrant-purple border-vibrant-purple/25 cursor-pointer'
                    : 'bg-vibrant-purple/20 text-vibrant-purple border-vibrant-purple/30 cursor-pointer hover:bg-vibrant-purple/30'
            case 'holiday':
                return isFuture
                    ? 'bg-vibrant-purple/15 text-vibrant-purple border-vibrant-purple/25 cursor-pointer'
                    : 'bg-vibrant-purple/20 text-vibrant-purple border-vibrant-purple/30 cursor-pointer hover:bg-vibrant-purple/30'
