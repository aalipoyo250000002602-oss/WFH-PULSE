							...
							<div className="relative pl-3">
								...
								<div className="space-y-2.5">
									{mappedLogs.map(log => {
										const Icon = log.icon
										const relativeTime =
											formatRelativeLogTime(log.loggedAt)
										return (
											<div
												key={log.activityId}
											...
											>
												...
												<div
													className={`p-2 rounded-lg ring-1 ring-border/30 ${log.bgColor}`}
												>
													<Icon
														className={`h-4 w-4 ${log.color}`}
													/>
												</div>

												<div className="flex-1">
													<p className="text-sm font-semibold text-foreground/95 leading-none">
														{log.label}
													</p>
													{relativeTime && (
