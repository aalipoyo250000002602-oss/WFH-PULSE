...
export function CalendarPage({
    ...
    const getStatusColor = (
        ...
        switch (status) {
            ...
            default:
                return 'text-muted-foreground hover:bg-muted/50 border-transparent'
        }
    }
    ...
    const handleSubmitLeaveRequest = () => {
        ...
        const selectedLeaveType = leaveTypes.find(
            lt => lt.id === leaveRequestForm.leaveType
        )

        if (selectedLeaveType && days > selectedLeaveType.credits) {
            toast.error(
                `Insufficient leave credits. You have ${selectedLeaveType.credits} days available.`
            )
            return
        }
    ...
    const recentLeaveRequests = leaveTypes.flatMap(lt =>
        lt.requests.map(req => ({
            ...req,
    ...
    const requestStatusChips: Array<{
        ...
        },
        {
            ...
            className:
                'border-muted-foreground/30 text-muted-foreground col-span-2',
        },
    ]
                    ...
                    >
                        <div className="flex items-center justify-between w-full">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <motion.div
                                    animate={{
                                        rotate: isFullCalendarOpen ? 180 : 0,
                                    }}
                                    transition={{
                                        duration: 0.3,
                                        ease: 'easeInOut',
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                {isLeaveDataLoading ? (
                                                    ...
                                                    <div className="pt-3 border-t border-border">
                                                        ...
                                                        <div className="space-y-2">
                                                            {filteredRecentLeaveRequests.length ===
                                                            0 ? (
                                                                ...
                                                                filteredRecentLeaveRequests.map(
                                                                    request => (
                                                                        <div
                                                                            key={
                                                                                request.id
                ...
                >
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Set details for the selected{' '}
                                {getBulkSelectedDates().length} holiday
                                {getBulkSelectedDates().length > 1 ? 's' : ''}.
                            </DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4">
                            <div>
                                <Label htmlFor="bulk-holiday-name">
                                    Holiday Name
                                </Label>
                                <Input
                            ...
                            <div className="flex gap-2">
                                <Button
                                    ...
                                    className="flex-1"
                                >
                                    Add {getBulkSelectedDates().length} Holiday
                                    {getBulkSelectedDates().length > 1
                                        ? 's'
                                        : ''}
                                </Button>
                                <Button
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="border rounded-lg p-4 bg-muted/20">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-7 gap-1">
                                            {days.map((day, index) => {
                                                ...
                                                const isLeaveStart =
                                                    leaveRangeStart === dateKey
                                                const isLeaveEnd =
                                                    leaveRangeEnd === dateKey
                                                const isInLeaveRange =
                                                    leaveRangeStart &&
                                                    leaveRangeEnd &&
                                                    getDatesInRange(
                                                ...
                                                if (
                                                    ...
                                                    bgColor =
                                                        'bg-vibrant-purple text-vibrant-purple-foreground'
                                                } else if (isInLeaveRange) {
                                                    bgColor =
                                                        'bg-vibrant-purple/30 text-vibrant-purple'
                                                } else if (isToday) {
                                                    bgColor =
                                                        'bg-vibrant-blue/20 text-vibrant-blue border-vibrant-blue'
                                                } else if (holiday) {
                                                    bgColor =
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        ...
                                        Click on the calendar to select your
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    {leaveRequestForm.attachments.length >
                                        0 && (
                                        <div className="space-y-2">
                                            {leaveRequestForm.attachments.map(
                                                (file, index) => (
                                                    <div
                                                        key={index}
                    ...
                    <DialogContent className="max-h-[90vh] overflow-y-auto">
                        ...
                        {selectedLeaveRequest && (
                            <div className="space-y-4">
                                ...
                                {/* Attachments */}
                                {selectedLeaveRequest.request.attachments
                                    .length > 0 && (
                                    <div>
                                        <Label>Attachments</Label>
                                        <div className="space-y-2 mt-2">
                                            {selectedLeaveRequest.request.attachments.map(
                                                (file, index) => (
                                                    <div
                                                        key={index}
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        {selectedLeaveRequest.request.logTrail.map(
                                            (log, index) => (
                                                <div
                                                    key={index}
