...
export function AnalyticsPage({
            ...
            <tbody>
              ${pieData
                  .map(item => {
                      const percentage =
                          totalDays > 0
                              ? Math.round((item.value / totalDays) * 100)
                              : 0
                      return `
                <tr>
    ...
    `
        ...
        link.setAttribute(
            'download',
            `attendance-analytics-${new Date().toISOString().split('T')[0]}.html`
        )
        link.style.visibility = 'hidden'
        document.body.appendChild(link)
        link.click()
                ...
                <Card>
                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <motion.div
                                animate={{
                                    rotate: isAttendanceSheetOpen ? 180 : 0,
                                }}
                                transition={{
                                    duration: 0.3,
                                    ease: 'easeInOut',
